...
Component {
    ...
    //area1 Input field
        Rectangle {
            ...
            border.color: "#c6c6c6"
            border.width: 1
    //Rectangle contain text Nhan vien can dau vao
            Rectangle {
                id: rectangle3
                x: 60
                y: 40
    ...
    //Rectangle input Nhan vien can dau vao
            Rectangle {
                id: rectangle4
                x: 442
                y: 40
    ...
    //Rectangle contain text Nhan vien tap ket phe lieu
            Rectangle {
                id: rectangle5
                x: 60
                y: 170
    ...
    //Rectangle input text Ma so thung bi
            Rectangle {
                id: rectangle6
                x: 442
                y: 303
    ...
    //Rectangle input text Khoi luong bi
            Rectangle {
                id: rectangle7
                x: 756
                y: 303
    ...
    //Rectangle contain text Thung bi
            Rectangle {
                id: rectangle8
                x: 60
                y: 303
    ...
    //Rectangle contain text Chung loai phe lieu
            Rectangle {
                id: rectangle9
                x: 60
                y: 435
    ...
    //rectangle input text Ma so nhan vien tap ket phe lieu
            Rectangle {
                id: rectangle13
                x: 442
                y: 170
    ...
    //Rectangle text input Phan xuong nhan vien tap ket
            Rectangle {
                id: rectangle14
                x: 756
                y: 170
    ...
    //Rectangle input Chung loai phe lieu
            Rectangle {
                id: rectangle15
                x: 442
                y: 435
    ...
    //Rectangle input Ten loai phe lieu
            Rectangle {
                id: rectangle17
                x: 756
                y: 435
    ...
    //rectangle input Xac nhan can nhap
            Rectangle {
                id: rectangle21
                x: 442
                y: 630
